...
import themeLight, {
  THEME_LIGHT_DEFAULT_ACCENT,
  THEME_LIGHT_DEFAULT_BACKGROUND,
  THEME_LIGHT_DEFAULT_NAV,
  THEME_LIGHT_DEFAULT_PAPER,
  THEME_LIGHT_DEFAULT_PRIMARY,
  THEME_LIGHT_DEFAULT_SECONDARY,
  THEME_LIGHT_DEFAULT_TEXT,
} from './ThemeLight';
...
const defaultTheme: AppThemeType = {
  name: 'Light',
  theme_accent: THEME_LIGHT_DEFAULT_ACCENT,
  theme_background: THEME_LIGHT_DEFAULT_BACKGROUND,
  theme_logo: '',
  theme_logo_collapsed: '',
  theme_logo_login: '',
  theme_nav: THEME_LIGHT_DEFAULT_NAV,
  theme_paper: THEME_LIGHT_DEFAULT_PAPER,
  theme_primary: THEME_LIGHT_DEFAULT_PRIMARY,
  theme_secondary: THEME_LIGHT_DEFAULT_SECONDARY,
  theme_text_color: THEME_LIGHT_DEFAULT_TEXT,
};
