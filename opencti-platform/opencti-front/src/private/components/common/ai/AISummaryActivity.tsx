...
const LegacyAISummaryActivity = ({ id, loading, setLoading }: AISummaryActivityProps) => {
...
// ── XTM One agent-based activity ────────────────────────────────────────

interface XtmOneActivityProps {
  id: string;
  loading: boolean;
  setLoading: (loading: boolean) => void;
  selectedAgent: AgentOption | null;
...
const XtmOneActivity = ({ id, loading, setLoading, selectedAgent }: XtmOneActivityProps) => {
  ...
  return (
    <XtmOneAISummaryDisplay
      disclaimerText={t_i18n('This summary is based on the evolution of the activity of this entity (indicators, victimology, etc.). It has been generated by AI and can contain mistakes.')}
      noAgent={noAgent}
...
const AISummaryActivity = ({ id, loading, setLoading, selectedAgent }: AISummaryActivityProps) => {
