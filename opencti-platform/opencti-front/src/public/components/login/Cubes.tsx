...
const Cubes = ({
  ...
  const resetAll = useCallback(() => {
    if (!sceneRef.current) return;
    sceneRef.current.querySelectorAll<HTMLElement>('.cube').forEach((cube) => gsap.to(cube, {
      duration: leaveDur,
      rotateX: 0,
      rotateY: 0,
      ease: 'power3.out',
  ...
  return (
    <div className="ravin-cubes" style={wrapperStyle}>
      <div ref={sceneRef} className="ravin-cubes--scene" style={sceneStyle}>
